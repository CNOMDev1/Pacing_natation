...
from desktop_heatmap_mixin import DesktopHeatmapMixin
from desktop_handlers_mixin import DesktopHandlersMixin
...
class PacingDesktopApp(DesktopPrefetchMixin, DesktopRegistryMixin, DesktopCorridorSwimmerMixin, DesktopHeatmapMixin, DesktopHandlersMixin):
