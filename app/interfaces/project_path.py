...
Ce module expose ``PROJECT_DIR`` et ``ensure_project_imports()`` pour permettre
les imports ``from services.…`` depuis ``app/interfaces/`` sans installation
en mode paquet. Il reste autonome (n'importe pas ``services``) pour pouvoir
