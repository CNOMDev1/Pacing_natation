...
# Supporte à la fois l'import comme module du package `app.services`
...
def fetch_and_save_2024_olympic_trials_results() -> Dict[str, Any]:
    ...
    dans la structure standard de `data/usaswimming` via `save_data_by_competition`.
    ...
    # Sauvegarde en JSON et CSV directement dans `app/data/`, hors dossier `usaswimming`
