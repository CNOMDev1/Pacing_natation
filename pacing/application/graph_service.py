...
La logique métier pure vit dans ``pacing.analytics.graph_compute`` ; le rendu matplotlib
non-couloir dans ``pacing.rendering.chart_plots`` ; les couloirs dans
``pacing.analytics.corridor_data`` et ``pacing.rendering.corridor_plots``.
