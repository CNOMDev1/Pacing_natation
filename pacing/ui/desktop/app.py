...
from pacing.config.settings import PREFETCH

ensure_project_imports()

from pacing.ui.widgets.loading_progress import TriplePrefetchProgress
from pacing.analytics.corridor_data import build_corridor_chart_plot_kwargs, CORRIDOR_CHART_STYLE_VERSION
from pacing.data.frmnatation_loader import (
    DEFAULT_FRMNATATION_HTML_RESULTS_DIR,
    FrmnatationHtmlResultsDataLoader,
)
from pacing.data.usaswimming_loader import (
    DEFAULT_USASWIMMING_COMPETITIONS_DIR,
    DEFAULT_USASWIMMING_PARQUET_DIR,
    UsaswimmingCompetitionsDataLoader,
)
from pacing.ui.widgets.swimmer_search import SwimmerSearch
from pacing.ui.desktop.helpers import (
...
from pacing.domain.stroke_labels import stroke_code_to_label
...
class PacingDesktopApp:
    ...
    def _build_corridor_chart_plot_kwargs(
        ...
        *,
        ...
        from pacing.analytics.corridor_data import CORRIDOR_FR_SWIMMER_COLOR, CORRIDOR_MA_SWIMMER_COLOR
...
def run() -> None:
    """
    Lance l'application desktop Flet (entry point console ``pacing-desktop``).
