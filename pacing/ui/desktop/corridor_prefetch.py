...
from pacing.ui.desktop.helpers import _figure_to_base64, _materialize_df_scope, _slugify
from pacing.application.graph_service import ServiceGraphe
from pacing.domain.stroke_labels import format_event_label
if TYPE_CHECKING:
    from pacing.ui.desktop.app import PacingDesktopApp
