...
Regroupe les flags de prefetch desktop et les limites associées, auparavant
dispersés en tête de ``desktop_flet``.
"""
...
def _env_bool(name: str, default: bool = True) -> bool:
    ...
    Args:
        ...
        default (bool): Valeur si la variable est absente.

    Returns:
        bool: True pour ``1/true/yes/on``, False pour ``0/false/no/off``.
    """
...
# Instance par défaut (lue une fois à l'import UI)
